...
import { Review, Platform } from '../types';
...
const Inbox: React.FC<InboxProps> = ({ onSelectReview }) => {
  const [filter, setFilter] = useState<'Todas' | 'Sem resposta' | 'Negativas' | Platform>('Todas');
