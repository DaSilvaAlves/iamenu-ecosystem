...
import { Search, SlidersHorizontal, X, MapPin, Users, FileText, TrendingUp, Clock, MessageSquare, Eye, Heart } from 'lucide-react';
import { CommunityAPI } from '../services/api';

const SearchView = ({ initialQuery = '', onNavigateToGroup, onNavigateToPost }) => {
    ...
    return (
        ...
        >
            ...
            {showFilters && (
                ...
                >
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                        <h3 style={{ fontSize: '1rem', fontWeight: '600' }}>Filtros Avançados</h3>
                        <button
            ...
            {!loading && !searchQuery && posts.length === 0 && groups.length === 0 && (
                <div className="glass-panel" style={{ padding: '60px 20px', textAlign: 'center' }}>
                    <Search size={48} color="var(--text-muted)" style={{ margin: '0 auto 16px' }} />
                    <h3 style={{ fontSize: '1.2rem', marginBottom: '8px' }}>Começa a pesquisar</h3>
                    <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>
