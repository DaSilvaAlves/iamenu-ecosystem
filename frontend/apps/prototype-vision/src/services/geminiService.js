...
export const generateAIResponse = async (reviewText, rating, tone) => {
  try {
    // Nota: A chave API deve ser configurada nas variáveis de ambiente
    // Para desenvolvimento, pode usar: import.meta.env.VITE_GEMINI_API_KEY
...
// Função auxiliar para respostas mock (desenvolvimento/fallback)
const getMockResponse = (rating, tone) => {
  if (rating <= 2) {
