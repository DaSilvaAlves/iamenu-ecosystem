...
const AlertsView = ({ setView }: AlertsViewProps) => {
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-gradient-to-br from-red-500/10 to-red-600/5 border border-red-500/20 rounded-2xl p-6">
          ...
          <p className="text-red-400 text-sm font-semibold">Requires immediate attention</p>
        </div>
...
const AlertCard = ({ alert, onDismiss, onAction }: AlertCardProps) => {
  const getIcon = () => {
    switch (alert.type) {
      case 'critical':
