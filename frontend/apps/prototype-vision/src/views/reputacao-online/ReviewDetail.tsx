...
interface ReviewDetailProps {
  review: { id: string; author: string; platform: string; rating: number; content: string; date: string; status: string; response?: string; avatar?: string; };
  onBack: () => void;
  onPost: (id: string, response: string) => void;
}

const ReviewDetail = ({ review, onBack, onPost }: ReviewDetailProps) => {
