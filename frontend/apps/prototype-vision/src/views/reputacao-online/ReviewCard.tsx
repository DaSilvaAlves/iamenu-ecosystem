...
interface ReviewCardProps {
  review: { id: string; author: string; platform: string; rating: number; content: string; date: string; status: string; response?: string; avatar?: string; table?: string; };
  onSelect: (review: ReviewCardProps['review']) => void;
}

const ReviewCard = ({ review, onSelect }: ReviewCardProps) => {
