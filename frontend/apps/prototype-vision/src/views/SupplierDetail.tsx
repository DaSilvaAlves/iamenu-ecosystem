...
function SupplierDetail() {
  ...
  if (!supplier) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          <p className="text-white/60 mb-4">Fornecedor nao encontrado.</p>
          <Link to="/marketplace" className="text-primary hover:text-primary-hover">
            Voltar ao Marketplace
          </Link>
        </div>
  ...
  const tabs: TabDef[] = [
    ...
    { id: 'catalog', label: 'Catalogo', badge: supplier.SupplierProducts?.length || 0 },
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 items-start">
        ...
        <div className="xl:col-span-8 flex flex-col gap-6">
          ...
          <section className="bg-surface rounded-xl border border-border overflow-hidden relative group">
                ...
                <div className="mb-1 flex-1">
                  <div className="flex items-center gap-3 mb-2 flex-wrap">
                    ...
                    <span className="flex items-center gap-1 text-yellow-500 text-sm">
                      ...
                      <span className="text-text-muted font-normal">({supplier.reviewCount || 0} avaliacoes)</span>
                    </span>
                  </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-border border-t border-border bg-white/5 backdrop-blur-sm">
              <div className="p-4 flex flex-col items-center justify-center text-center">
                <span className="text-text-muted text-[10px] uppercase font-bold tracking-wider mb-1">Minimo Enc.</span>
              ...
              <div className="p-4 flex flex-col items-center justify-center text-center">
                ...
                <span className="text-xl font-bold text-primary">
                  {supplier.deliveryCost || 'Gratis > 300\u20AC'}
                </span>
              </div>
              <div className="p-4 flex flex-col items-center justify-center text-center">
          ...
          <div className="space-y-6">
              ...
              <>
                ...
                <div className="bg-surface p-6 rounded-xl border border-border">
                  ...
                  <p className="text-text-muted leading-relaxed text-sm">
                    {supplier.description || 'Lider na distribuicao de produtos frescos e laticinios na regiao da Grande Lisboa ha mais de 15 anos. Somos o parceiro de confianca para mais de 500 restaurantes, hoteis e cafes.'}
                  </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-surface p-6 rounded-xl border border-border">
                    ...
                    <ul className="space-y-3 text-sm">
                      ...
                      <li className="flex items-start gap-3 text-text-muted">
                        <CheckCircle className="text-primary mt-0.5 shrink-0" size={18} />
                        <span>Area: {supplier.deliveryZones?.join(', ') || 'Grande Lisboa, Sintra, Cascais'}</span>
                      </li>
                      <li className="flex items-start gap-3 text-text-muted">
                        <CheckCircle className="text-primary mt-0.5 shrink-0" size={18} />
                  ...
                  <div className="bg-surface p-6 rounded-xl border border-border">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3 className="text-lg font-bold text-white">Devolucoes e Qualidade</h3>
                    </div>
                    <ul className="space-y-3 text-sm">
                      <li className="flex items-start gap-3 text-text-muted">
                        <CheckCircle className="text-primary mt-0.5 shrink-0" size={18} />
                        <span>Devolucao no ato da entrega aceite</span>
                      </li>
                      <li className="flex items-start gap-3 text-text-muted">
                        <CheckCircle className="text-primary mt-0.5 shrink-0" size={18} />
                        <span>Reclamacoes ate 24h para pereciveis</span>
                      </li>
                      <li className="flex items-start gap-3 text-text-muted">
                        <CheckCircle className="text-primary mt-0.5 shrink-0" size={18} />
                        <span>Certificacao HACCP em toda a frota</span>
                      </li>
                    </ul>
                  </div>
                </div>
                  ...
                  <section className="bg-surface rounded-xl border border-border p-6">
                    <div className="flex justify-between items-end mb-6">
                      <div>
                        ...
                        <p className="text-sm text-text-muted">Produtos com maior procura nesta epoca</p>
                      </div>
                      <button
            ...
            {activeTab === 'catalog' && (
              <div className="bg-surface p-6 rounded-xl border border-border">
                <h2 className="text-2xl font-bold text-white mb-6">Catalogo de Produtos</h2>
                {supplier.SupplierProducts && supplier.SupplierProducts.length > 0 ? (
                  ...
                  <div className="text-center py-12">
                    <p className="text-text-muted">Este fornecedor ainda nao tem produtos no catalogo.</p>
                  </div>
                )}
              </div>
            )}
            ...
            {activeTab === 'reviews' && (
              <div className="bg-surface p-6 rounded-xl border border-border">
                <h2 className="text-2xl font-bold text-white mb-6">Avaliacoes</h2>
                <div className="text-center py-12">
                  <p className="text-text-muted">Funcionalidade de avaliacoes em desenvolvimento.</p>
                </div>
              </div>
            )}
            ...
            {activeTab === 'policies' && (
              <div className="bg-surface p-6 rounded-xl border border-border">
                <h2 className="text-2xl font-bold text-white mb-6">Politicas</h2>
                <div className="space-y-4 text-text-muted text-sm leading-relaxed">
                  <div>
                    ...
                    <p>{supplier.paymentTerms || '30 dias apos entrega'}</p>
                  </div>
                  <div>
                    <h3 className="text-white font-bold mb-2">Politica de Devolucao</h3>
                    <p>Aceitamos devolucoes no ato da entrega para produtos com problemas de qualidade.</p>
                  </div>
                  <div>
                    <h3 className="text-white font-bold mb-2">Cancelamento de Encomendas</h3>
                    <p>Encomendas podem ser canceladas ate as 16h do dia anterior a entrega.</p>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="bg-surface p-6 rounded-xl border border-border">
              ...
              <div className="flex flex-col gap-3">
                {supplier.certifications.map((cert, index) => {
                  const certConfig: Record<string, { icon: string; color: string; label: string }> = {
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-xs text-text-muted">
                          ...
                          {config.color === 'blue' && 'Seguranca alimentar garantida'}
                          {config.color === 'emerald' && 'Apoio a economia regional'}
                        </p>
                      </div>
                    </div>
                  );
          ...
          <div className="bg-surface p-6 rounded-xl border border-border">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-primary mt-0.5">Disponivel</p>
              </div>
            </div>
