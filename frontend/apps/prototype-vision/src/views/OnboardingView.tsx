...
const OnboardingView = ({ onComplete }: OnboardingViewProps) => {
  ...
  const [apiResponse, setApiResponse] = useState<OnboardingApiResponse | null>(null);
  ...
  const steps = [
    {
      ...
      subtitle: 'Informacoes basicas do seu negocio',
      icon: '🍽️',
      color: '#ff4d00'
    },
    {
      id: 1,
      title: 'Configuracao de Menu',
      subtitle: 'Upload do cardapio ou adicao manual',
      icon: '📋',
      color: '#3b82f6'
    },
    {
    ...
    },
    {
      ...
      subtitle: 'A nossa IA esta a processar os dados',
      icon: '🤖',
      color: '#ec4899'
    },
    {
  ...
  const nextStep = async () => {
    if (currentStep === 3) {
      ...
      try {
        ...
        setApiResponse(response.data as OnboardingApiResponse);
        ...
        alert('Erro ao configurar restaurante: ' + message);
        setIsProcessing(false);
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
      <div className="form-group">
        ...
        <input
          ...
          placeholder="Ex: Restaurante O Patio"
        />
      </div>
    ...
    <div className="max-w-4xl mx-auto">
      <div className="grid grid-cols-2 gap-4 mb-8">
        ...
        >
          ...
          <p className="text-sm text-white/60">Mais rapido (Recomendado)</p>
        </button>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
      <div className="form-group">
        ...
        <input
          ...
          placeholder="Ex: 5000"
        />
        <p className="text-xs text-white/40 mt-1">Renda, agua, luz, gas, etc.</p>
      </div>
      ...
      <div className="form-group">
        ...
        />
        <p className="text-xs text-white/40 mt-1">Valor medio por cliente</p>
      </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
      ...
      <div className="form-group">
        ...
        <input
          ...
          placeholder="3"
        />
        <p className="text-xs text-white/40 mt-1">Vezes por servico</p>
      </div>
  ...
  const renderStep5 = () => (
    <div className="max-w-2xl mx-auto text-center">
      ...
      <h3 className="text-2xl font-bold text-white mb-4">A Nossa IA Esta a Trabalhar...</h3>
  ...
  const renderStep6 = () => {
    ...
    return (
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-white/60">
            {productsCount} produtos analisados - Ja identificamos oportunidades de melhoria
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          ...
          <div className="bg-gradient-to-br from-yellow-500/20 to-yellow-600/10 border border-yellow-500/30 rounded-xl p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-bold text-white mb-1">Alertas Criticos</h4>
                <p className="text-2xl font-black text-yellow-400 mb-2">
                  {insights.criticalAlerts || 0}
                </p>
                <p className="text-sm text-white/60">Requerem atencao imediata</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white/5 border border-white/20 rounded-xl p-6 mb-8">
        <h4 className="font-bold text-white mb-4">Primeiras Recomendacoes:</h4>
        {insights.recommendations && insights.recommendations.length > 0 ? (
          ...
          <p className="text-white/60">
            Analise completa! Food Cost medio: {insights.avgFoodCost?.toFixed(1)}% |
            Margem media: {insights.avgMargin?.toFixed(1)}%
          </p>
        )}
      </div>
          ...
          >
            ...
            {currentStep !== 4 && currentStep !== 5 && (
              <div className="flex justify-center gap-4">
                ...
                >
                  {currentStep === 3 ? 'Analisar com IA' : 'Proximo'}
