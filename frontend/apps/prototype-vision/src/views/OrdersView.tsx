                ...
                {[1, 2].map((_, i) => (
                    <div key={i} className="flex justify-between items-center">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-xs font-bold text-white/80 italic">Item Sugestao #{i + 1}</span>
                        </div>
                    </div>
                ))}
            </div>
...
const OrdersView = () => {
    ...
    useEffect(() => {
        ...
        if (data.length === 0) {
            ...
            setOrders([
                { id: '#ORD-1247', time: 'Ha 5 min', status: 'pending', value: 45.50 },
                { id: '#ORD-1246', time: 'Ha 12 min', status: 'completed', value: 67.80 },
                { id: '#ORD-1245', time: 'Ha 18 min', status: 'completed', value: 32.90 },
                { id: '#ORD-1244', time: 'Ha 25 min', status: 'pending', value: 89.20 }
            ]);
        } else {
        ...
        >
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-white/5 p-8 rounded-[32px] border border-white/10 backdrop-blur-3xl">
                <div>
                    ...
                    <p className="text-white/40 font-bold text-sm ml-12">Gestao de fluxo de pedidos em tempo real.</p>
                </div>
