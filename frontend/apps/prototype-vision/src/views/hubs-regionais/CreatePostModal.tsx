...
const POST_CATEGORIES: Record<string, { label: string; icon: string }> = {
    DICA: { label: 'Dica', icon: 'lightbulb' },
    DUVIDA: { label: 'Duvida', icon: 'help' },
...
const CreatePostModal = ({ onClose, onSubmit, hub }: CreatePostModalProps) => {
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-3">
                            ...
                            <textarea
                                ...
                                placeholder="Partilhe a sua experiencia, dica ou duvida..."
                                required
                                rows={6}
