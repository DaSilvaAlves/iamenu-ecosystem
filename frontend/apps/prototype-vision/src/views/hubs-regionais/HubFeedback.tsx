...
const HubFeedback = ({ hub: _hub }: HubFeedbackProps) => {
    ...
    const handleExpand = async () => {
        ...
        setTimeout(() => {
            const expanded = `${description}\n\nContexto adicional: Esta dor afeta diretamente a operacao diaria do restaurante, impactando a rentabilidade e a experiencia do cliente. Seria valioso ter uma solucao integrada no iaMenu que permita monitorizar e otimizar este aspecto.`;
    ...
    const getImpactColor = (impactValue: string): string => {
        ...
        return colors[level?.color ?? 'yellow'] || colors.yellow;
    };
            ...
            <div className="glass-panel p-8 rounded-[30px] relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-white/60 text-sm mb-4 max-w-2xl">
                        A sua opiniao alimenta diretamente o Roadmap do iaMenu. Partilhe os desafios que enfrenta na sua regiao
                        e ajude-nos a criar solucoes que fazem a diferenca.
                    </p>
                    <div className="flex items-center gap-2 bg-white/5 border border-primary/20 px-4 py-2 rounded-2xl w-fit">
                        <Sparkles size={16} className="text-primary" />
                        <span className="text-white text-xs font-bold">AI Assistant disponivel</span>
                    </div>
                </div>
            </div>
                ...
                <div className="glass-panel p-8 rounded-[30px] space-y-6">
                    ...
                    <div className="space-y-3">
                        ...
                        <textarea
                            ...
                            placeholder="Descreva aqui a dor que esta a sentir no seu negocio..."
                        ></textarea>
                    </div>
                </div>
