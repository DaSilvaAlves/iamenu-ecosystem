...
import { FileText, Download, Star, Phone, ExternalLink } from 'lucide-react';

const HubResources = ({ hub }) => {
    const [downloadingId, setDownloadingId] = useState(null);

    const documents = [
        { id: 1, title: `Guia de Sazonalidade ${hub.region} 2024`, type: 'PDF', size: '2.4 MB', icon: 'picture_as_pdf' },
        { id: 2, title: 'Calculadora de Margem de Verão', type: 'XLSX', size: '1.1 MB', icon: 'table_view' },
        { id: 3, title: 'Regulamentação Local Esplanadas', type: 'PDF', size: '800 KB', icon: 'picture_as_pdf' },
    ...
    const partners = [
        ...
        { id: 2, name: 'EcoCleaning Services', category: 'Manutenção', rating: 4.5, phone: '+351 282 987 654' },
            ...
            <div className="bg-primary/5 border border-primary/20 rounded-[30px] p-6 flex items-start gap-4">
                ...
                <div>
                    ...
                    <p className="text-sm text-white/60 leading-relaxed">
                        Os recursos aqui listados são específicos para o <strong className="text-white">{hub.name}</strong>.
