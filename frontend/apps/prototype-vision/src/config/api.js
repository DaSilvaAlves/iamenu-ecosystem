...
export const API_CONFIG = {
  ...
  COMMUNITY_API: isVercel
    ...
    : (import.meta.env.VITE_COMMUNITY_API_URL || (isProd ? 'https://iamenucommunity-api-production.up.railway.app/api/v1/community' : 'http://localhost:3001/api/v1/community')),

  MARKETPLACE_API: isVercel
    ? 'https://iamenumarketplace-api-production.up.railway.app/api/v1/marketplace'
    : (import.meta.env.VITE_MARKETPLACE_API_URL || (isProd ? 'https://iamenumarketplace-api-production.up.railway.app/api/v1/marketplace' : 'http://localhost:3002/api/v1/marketplace')),

  BUSINESS_API: isVercel
    ? 'https://iamenubusiness-api-production.up.railway.app/api/v1/business'
    : (import.meta.env.VITE_BUSINESS_API_URL || (isProd ? 'https://iamenubusiness-api-production.up.railway.app/api/v1/business' : 'http://localhost:3004/api/v1/business')),
  ...
  COMMUNITY_BASE: isVercel
    ...
    : (import.meta.env.VITE_COMMUNITY_API_URL?.replace('/api/v1/community', '') || (isProd ? 'https://iamenucommunity-api-production.up.railway.app' : 'http://localhost:3001')),

  MARKETPLACE_BASE: isVercel
    ? 'https://iamenumarketplace-api-production.up.railway.app'
    : (import.meta.env.VITE_MARKETPLACE_API_URL?.replace('/api/v1/marketplace', '') || (isProd ? 'https://iamenumarketplace-api-production.up.railway.app' : 'http://localhost:3002')),
